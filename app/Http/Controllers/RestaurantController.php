...
class RestaurantController extends Controller
{
    ...
    public function show(Request $request, $id){
        $data = ['id','bookable_type_id','title','slug','description','merchant_id',
                'location','city','state','drink_types','dining_options','has_outdoor_sitting',
                'opening_and_closing_hours','extra_perks','cancellation_policy'];
