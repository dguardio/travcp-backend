...
<head>
    ...
    <link href="{{ asset ('mail/assets/textboxio/resources/css/textboxio.css') }}" rel="stylesheet">
...
<header class="app-header navbar">
 	...
 	<main class="main-content" id="app">
            ...
            <form class="category-form" id="form" action="{{route('mail.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-8">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="PostTitle" name="from" class="form-control" placeholder="From" required="" autocomplete="off" style="height: 48px;">
                                        
                                    </div>
                                    <div class="form-group">
                                        <label for="Post Title" class="sr-only">Subject</label>
                                        <input type="text" id="PostTitle" name="subject" class="form-control" placeholder="Subject" required="" autocomplete="off" style="height: 48px;">
                                    </div>

                                    <div>
                                        <textarea id="textbox" name="body" style="width: 100%; height: 400px;" placeholder="Type in your message here">
                                        </textarea>
                                    </div>
...
<script src="{{ asset('mail/assets/textboxio/textboxio.js')}}"></script>
